...
import (
	...
	"github.com/bcos-one/BCOS/internal/jsre"
	"github.com/bcos-one/BCOS/internal/web3ext"
...
func (c *Console) init(preload []string) error {
	...
	if global.ClientIdentifier != "geth" {
		flatten += fmt.Sprintf("var %s = web3.eth; ", params.ClientIdentifier)
	}
...
func (c *Console) Welcome() {
	...
	fmt.Fprintf(c.printer, "Welcome to the Geth and BCOS JavaScript console!\n\n")
	fmt.Fprintf(c.printer, "                ____   ____ ___  ____\n")
	fmt.Fprintf(c.printer, "               | __ ) / ___/ _ \\/ ___|\n")
	fmt.Fprintf(c.printer, "               |  _ \\| |  | | | \\___ \\\n")
	fmt.Fprintf(c.printer, "               | |_) | |__| |_| |___) |\n")
	fmt.Fprintf(c.printer, "               |____/ \\____\\___/|____/\n")
...
// Welcome show summary of current Geth instance and some metadata about the
// console's available modules.
func (c *Console) WelcomeToBCOS() {
	// Print some generic Geth metadata
	fmt.Fprintf(c.printer, "Welcome to the "+params.ClientNetIdentifier+" JavaScript console!\n")
	fmt.Fprint(c.printer, params.WelcomeMessage)
	c.jsre.Run(`
		console.log("instance: " + web3.version.node);
		console.log("coinbase: " + eth.coinbase);
		console.log("at block: " + eth.blockNumber + " (" + new Date(1000 * eth.getBlock(eth.blockNumber).timestamp) + ")");
