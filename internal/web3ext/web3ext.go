...
var Modules = map[string]string{
	...
	params.ClientIdentifier: BCOS_JS,
}
...
web3._extend({
	...
	methods: [
		new web3._extend.Method({
			name: 'getSnapshot',
			call: 'wpoa_getSnapshot',
			params: 1,
			inputFormatter: [null]
		}),
		new web3._extend.Method({
			name: 'getSnapshotAtHash',
			call: 'wpoa_getSnapshotAtHash',
			params: 1
		}),
		new web3._extend.Method({
			name: 'getSigners',
			call: 'wpoa_getSigners',
			params: 1,
			inputFormatter: [null]
		}),
		new web3._extend.Method({
			name: 'getSignersAtHash',
			call: 'wpoa_getSignersAtHash',
			params: 1
		}),
		new web3._extend.Method({
			name: 'getManagers',
			call: 'wpoa_getManagers',
			params: 1,
			inputFormatter: [null]
		}),
		new web3._extend.Method({
			name: 'getManagersAtHash',
			call: 'wpoa_getManagersAtHash',
			params: 1
		}),
	],
	properties: [
