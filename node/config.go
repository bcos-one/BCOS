...
import (
	...
	"github.com/bcos-one/BCOS/accounts/usbwallet"
...
func (c *Config) ResolvePath(path string) string {
	...
	if (c.name() == "geth" || c.name() == params.ClientIdentifier) && isOldGethResource[path] {
		oldpath := ""
		if c.Name == "geth" ||  c.name() == params.ClientIdentifier  {
